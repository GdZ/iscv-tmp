...
evaluate:
	python2 solution/evaluate_ate_v2.py solution/data/groundtruth.txt solution/data/estimate_ab.txt  --plot solution/output/figure-ab-0.052-$(shell date +"%Y%m%d.%H%M%M").png --offset 0 --scale 1 --verbose
